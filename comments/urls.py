...
urlpatterns = [
    ...
    path('comments/<int:comment_id>/likes/create/',
         LikeCreate.as_view(), name='like-create'),
    path('comments/<int:comment_id>/likes/delete/<int:pk>/',
         LikeDelete.as_view(), name='like-delete'),
